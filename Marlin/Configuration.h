...
#define STRING_CONFIG_H_AUTHOR "(H3D_Genius_BL_HEM_2.0.9.1_V1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Artillery Genius BLTOUCH HEMERA - Patreon Edition"

...
#define STRING_CONFIG_H_AUTHOR "(H3D_Genius_MB_HEM_2.0.9.1_V1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Artillery Genius Mesh Bed HEMERA - Patreon Edition"

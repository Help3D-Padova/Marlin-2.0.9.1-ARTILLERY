...
#define STRING_CONFIG_H_AUTHOR "(H3D_Artillery_Genius_Mesh_Bed_2.0.9.1_V1_Piraz)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Artillery Genius Mesh Bed - Patreon Edition"

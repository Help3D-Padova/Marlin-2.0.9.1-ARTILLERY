...
#define STRING_CONFIG_H_AUTHOR "(H3D_X1_BL_HEM_5V_2.0.9.1_V1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Artillery X1 BLTOUCH HEMERA 5V - Patreon Edition"
